...
- [postgres_dba](https://github.com/NikolayS/postgres_dba#postgres_dba-postgresdba) approximatively the same eries but shows also how to add custom commands to postgres
